				...
				<div className="about-info">
					...
					<div className="bio">
						...
						<p>
							...
							worked a lot with WordPress since then, making many fully responsive, multi-platform web
							sites.
						</p>
						<p>
							In my spare time I like to drink too much coffee, eat really spicy food and work out. On the
							off chance that you ride a unicycle, or have scoliosis, please do let me know, I'd love to
							chat about it.
						</p>
					</div>
					<div className="title">
